...
func release_truth():
	...
	tween.interpolate_property(HUD.screen_stat.get_material(), "shader_param/contrast", 1.5, 2, 1, Tween.TRANS_LINEAR, Tween.EASE_OUT)
...
func _on_truth_path_completed():
	tween.interpolate_property(HUD.screen_stat.get_material(), "shader_param/contrast", 2, 1.5, 1, Tween.TRANS_LINEAR, Tween.EASE_OUT)
